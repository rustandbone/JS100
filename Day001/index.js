...
gridButton.addEventListener('click', () => {
  ...
  for (let i = 0; i < gridHeight.value; i++) {
    ...
    for (let j = 0; j < gridWidth.value; j++) {
      ...
      div.addEventListener(events[deviceType].move, (e) => {
...
eraseBtn.addEventListener('click', () => {
  erase = true;
  eraseBtn.style.backgroundColor = 'brown';
  paintBtn.style.backgroundColor = '#43a047';
});

paintBtn.addEventListener('click', () => {
  erase = false;
  eraseBtn.style.backgroundColor = '#43a047';
  paintBtn.style.backgroundColor = 'brown';
});
